...
namespace studentreg
{
    public partial class Form1 : Form
    {
        ...
        //      SqlConnection con = new SqlConnection("Data Source=.\\sqlexpress;Initial Catalog=gcbt;Integrated Security=True");

        MySqlConnection con = new MySqlConnection(" Server = 68.178.155.64 ; Port = 3306; Database = gcbt; Uid = gcbt; Pwd = y]TpqISq0zAQ; ");
        MySqlCommand cmd;
